...
class AgentsSkill {
  ...
  static AgentsSkill? fromPayload(Map<String, dynamic> payload) {
  ...
  AgentsSkill copyWith({bool? enabled}) => AgentsSkill(
    name: name,
  ...
  @override
  String toString() => 'AgentsSkill($name, $source, ${enabled ? 'on' : 'off'})';
}
...
/// AgentsSkillsControl` before it sends.
abstract interface class AgentsSkillsControl {
