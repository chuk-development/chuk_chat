...
/// is queued in [CoworkTaskOutbox], and until it goes out the user must be
...
class CoworkQueuedMarks {
  ...
  ///
  /// [CoworkChatStore.replaceThread] uses it to carry a mark across a write
  ...
  static Future<bool> _mutate(
    ...
    try {
      ...
      if (kDebugMode) {
        debugPrint('[cowork-outbox] queue mark failed for $sessionKey: $error');
      }
      return false;
    }
  }
