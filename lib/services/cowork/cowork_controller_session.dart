...
import 'cowork_pairing_store.dart';
import 'cowork_reconnect.dart';

class CoworkControllerSession {
  CoworkControllerSession(this.deviceId, this.identity, this.trust);

  final String deviceId;
  final SimpleKeyPair identity;
  final CoworkStoredPairing trust;
  final String nonce = base64Encode(CoworkReconnectCrypto.randomNonce());
  String? connection;
  String? _public;
