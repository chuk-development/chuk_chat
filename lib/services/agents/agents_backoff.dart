...
/// part Agents needs: the delay curve. Upstream's `ExponentialBackoff.execute`
...
class AgentsBackoff {
  ...
  static const AgentsBackoff chat = AgentsBackoff();

  /// How many attempts the curve is drawn for. The outbox keeps its own,
  /// higher give-up cap ([AgentsTaskOutbox.maxAttempts]); this is the point
