...
class ToolCallHandler {
  ...
  /// RESTORED from upstream. The stub drops the client tool LOOP, not the
  /// executor's registry: `pages/tool_calling_settings_page.dart` reads this to
  /// list the tools and their on/off state, and nothing here dispatches a tool.
