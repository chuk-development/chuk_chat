...
- User wants pictures of REAL things (people, actors, celebrities, movies, posters, places, products, cars, animals, food, events) -> call `web_search` with `type: "images"` to get real image URLs, then `fetch_image` on the best image_url to display the real photo inline.
