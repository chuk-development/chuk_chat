// AGENTS STUB. Upstream: chuk_chat/lib/services/streaming_chat_service.dart @ d31526a229fdde27c82adf3661d5d3a149db8340.
// Reason: replaced by relay — the SSE path to the hosted API does not exist in
// Agents. Only the exception type survives: streaming_manager_io.dart,
...
class StreamingChatService {
  ...
  static Stream<ChatStreamEvent> sendStreamingChat({
    ...
    return Stream<ChatStreamEvent>.error(
      const StreamingChatException('SSE streaming is not used in Agents.'),
    );
  }
}
