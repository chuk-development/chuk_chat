...
// which reads "Chuk Chat — Private and Secure. Always." CoWork has no such
...
// (see widgets/sidebar/sidebar_chrome.dart), so in CoWork it is a fallback that
// keeps the verbatim sidebar chrome compiling.
