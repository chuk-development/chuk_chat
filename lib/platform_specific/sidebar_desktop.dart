...
class SidebarDesktop extends StatefulWidget { // Renamed from CustomSidebar
  ...
  const SidebarDesktop({ // Renamed constructor
    Key? key,
  ...
  @override
  State<SidebarDesktop> createState() => _SidebarDesktopState(); // Renamed
}

class _SidebarDesktopState extends State<SidebarDesktop> { // Renamed
  ...
  @override
  void didUpdateWidget(covariant SidebarDesktop oldWidget) { // Renamed
