...
import 'package:cowork/platform_specific/chat/chat_api_service.dart'; // NEW
...
import 'package:cowork/widgets/workspace_panel.dart';
import 'package:cowork/utils/shift_key_tracker.dart';
import 'package:cowork/widgets/workspace_selection_dropdown.dart';
...
import 'package:cowork/utils/desktop_drop_stub.dart'
...
import 'package:cowork/platform_specific/chat/handlers/desktop_clipboard_handler.dart';
import 'package:cowork/platform_specific/chat/handlers/desktop_file_handler.dart';
...
class ChukChatUIDesktopState extends State<ChukChatUIDesktop>
  ...
  void _loadChatById(String? chatId) {
    ...
    // The regenerate seed belongs to the chat we are leaving. If that chat's
