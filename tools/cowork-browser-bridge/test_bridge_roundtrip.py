"""Run: python3 tools/cowork-browser-bridge/test_bridge_roundtrip.py
...
ROOT = HERE.parents[1]
MCP = ROOT / "tools" / "cowork-extension-mcp" / "cowork_extension_mcp.py"
BRIDGE = HERE / "cowork_browser_bridge.py"

sys.path.insert(0, str(ROOT / "tools" / "cowork-extension-mcp"))
...
def main() -> int:
    ...
    env = dict(os.environ, COWORK_BRIDGE_SOCKET=str(socket_path))
