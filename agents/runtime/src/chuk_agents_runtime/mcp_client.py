...
:func:`chuk_agents_runtime.prompt.render_tool_docs` drops its tools from the prompt.
...
:mod:`chuk_agents_runtime.oauth_bridge`, which is the documented exception to "no raw
...
CONFIG_NAMES = (".agents/mcp.json", "mcp.json")
...
#: :class:`chuk_agents_runtime.oauth_bridge.CredentialStash`.
...
class MCPServerConfig:
    ...
    #:   callback (:mod:`chuk_agents_runtime.oauth_bridge`).
    ...
    #: :func:`chuk_agents_runtime.oauth_bridge.config_token_exchange` reads the first
...
BROWSER_HOME_ENV = "AGENTS_BROWSER_HOME"
...
BROWSER_AUTO_OPEN_ENV = "AGENTS_BROWSER_AUTO_OPEN"
