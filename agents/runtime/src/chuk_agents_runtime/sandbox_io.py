...
:meth:`~chuk_agents_runtime.environment.Environment.run_bash` (§7.3). So the bytes come
...
(``chuk_agents_sandbox.base.DEFAULT_MAX_OUTPUT_CHARS`` = 100 000 chars) so that one
