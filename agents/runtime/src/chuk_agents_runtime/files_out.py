...
(:func:`chuk_agents_executor.protocol.file_payload`); a test binds it to a list.
...
# (:mod:`chuk_agents_runtime.sandbox_io`), so 8 MiB is on the order of 170 round trips.
