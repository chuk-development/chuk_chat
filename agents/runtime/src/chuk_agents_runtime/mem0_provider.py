...
Mem0's fact-extraction step needs a chat LLM. The rest of Agents already has one
— :class:`chuk_agents_runtime.backend.BackendModelClient`, which talks to
...
def register_provider() -> None:
    ...
    target = ("chuk_agents_runtime.mem0_provider.ChukBackendLLM", BaseLlmConfig)
