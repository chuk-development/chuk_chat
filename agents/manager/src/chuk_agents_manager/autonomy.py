...
from chuk_agents_manager.daily_summary import ModelClient, daily_summary_script
from chuk_agents_manager.scheduler import Job, JobMode, Scheduler
...
def register_daily_summary(
    ...
    *,
    ...
    (:func:`~chuk_agents_manager.daily_summary.daily_summary_script`) that reads the
