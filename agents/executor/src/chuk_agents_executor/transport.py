...
Each endpoint satisfies ``chuk_agents_manager.relay.Transport`` (a ``send(bytes)``
...
payload that crosses it is an already-sealed Agents frame.
"""
...
class LoopbackEndpoint:
    ...
    # -- chuk_agents_manager.relay.Transport ----------------------------------
