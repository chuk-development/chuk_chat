...
restarts. So every check in :mod:`chuk_agents_config.loader` appends a
...
class ConfigError(Exception):
    ...
    def _render(self) -> str:
        ...
        head = "1 problem in the Agents configuration:" if count == 1 else (
            f"{count} problems in the Agents configuration:"
        )
