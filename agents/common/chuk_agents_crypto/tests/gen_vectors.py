...
chuk_chat side must feed the same inputs to ``AgentsFrameSealer`` and confirm it
...
def build() -> dict:
    ...
    return {
        "_comment": (
            "Cross-language byte-compat vector for Agents frame crypto. "
            "The Dart AgentsFrameSealer, fed these exact inputs, MUST produce "
