...
After running, copy the fixture into the app test tree:
    cp tests/fixtures/reconnect_vectors.json \\
       ../../app/test/fixtures/agents_reconnect_vectors.json
"""
...
from chuk_agents_crypto import DeviceIdentity, ReconnectHandshake
from chuk_agents_crypto.reconnect import (
    RECONNECT_I_LABEL,
    RECONNECT_J_LABEL,
