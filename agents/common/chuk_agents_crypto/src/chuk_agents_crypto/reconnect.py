...
Python twin of ``agents_reconnect.dart``. Once a first pairing (§15) has
...
it plugs into :class:`AgentsFrameSealer` / :class:`AgentsFrameOpener` exactly as
...
# --- byte-exact protocol constants (mirror agents_reconnect.dart) ------------
