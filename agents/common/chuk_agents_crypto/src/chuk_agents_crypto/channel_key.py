"""Agents channel key — established at pairing by X25519 ECDH.

Per §14 of the platform plan, the symmetric key that seals Agents frames is a
**fresh Agents channel key**, established at pairing between controller and
...
Agents crypto from chat crypto.
...
def derive_channel_key(
    ...
    """Derive the 32-byte AES-256 Agents channel key by X25519 ECDH + HKDF.
