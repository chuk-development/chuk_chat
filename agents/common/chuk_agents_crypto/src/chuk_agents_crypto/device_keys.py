"""Per-device Ed25519 identity — the Python twin of the Dart ``AgentsDeviceKeys``.
...
Mirrors ``agents_device_keys.dart``.
"""
...
def public_key_from_base64(encoded: str) -> Ed25519PublicKey:
    ...
    trusted key. Mirrors ``publicKeyFromBase64`` in agents_device_keys.dart:71."""
