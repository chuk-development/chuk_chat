...
``host_device.key`` (see :mod:`chuk_agents_host.identity`) and is loaded separately.
...
from chuk_agents_crypto import ApprovedDevices, public_key_from_base64
...
class HostTrust:
    ...
    def approved_devices(self) -> ApprovedDevices:
        ...
        to hand to a :class:`AgentsFrameOpener`."""
