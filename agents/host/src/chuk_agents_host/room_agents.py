...
:class:`~chuk_agents_executor.Executor` on **its own** loopback link, wrap a
:class:`~chuk_agents_executor.ControllerSession` around the other end, and register
...
from chuk_agents_manager import RoomBinding, RoomMember
...
class _Link:
    ...
    controller_sealer: AgentsFrameSealer
    controller_opener: AgentsFrameOpener
    executor_sealer: AgentsFrameSealer
    executor_opener: AgentsFrameOpener
