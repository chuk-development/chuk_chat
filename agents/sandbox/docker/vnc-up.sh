...
# Latency/stability tuning, measured with agents/executor/tests/live_vnc_connect_probe.py
...
#
# Throughput tuning (measured earlier, agents/executor/tests/live_vnc_speed_probe.py):
