...
void main() {
  ...
  testWidgets('asks the executor for the stream and waits for its started event',
      (tester) async {
  ...
  testWidgets('full screen hides the chrome and a floating button brings it back',
      (tester) async {
    await pumpPage(tester);
    ...
    expect(find.byKey(const Key('browser_view_exit_fullscreen')), findsOneWidget);
  ...
  testWidgets('open() pushes a full-screen dialog route; leaving stops the stream',
      (tester) async {
