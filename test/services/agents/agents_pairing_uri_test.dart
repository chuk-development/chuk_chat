...
void main() {
  ...
  group('AgentsPairingInvite.tryParse', () {
    test('reads the full pairing URI the host prints', () {
      final invite = AgentsPairingInvite.tryParse(
    ...
    test('all three forms of the same invite resolve identically', () {
      ...
      final scanned = AgentsPairingInvite.tryParse(
        'cowork://pair?c=$channel&k=428913',
      );
      final pasted = AgentsPairingInvite.tryParse(
        'Scan this, or type the code:\n'
        '  cowork://pair?c=$channel&k=428913  \n'
        'It expires in five minutes.',
      );
      final typed = AgentsPairingInvite.tryParse('$channel-428913');
    ...
    test('the typed code carries its own channel', () {
      ...
      final invite = AgentsPairingInvite.tryParse('  $channel-428913 ');
    ...
    test('a malformed invite is null, never a half-built connection', () {
      ...
      for (final raw in cases) {
        expect(
          AgentsPairingInvite.tryParse(raw),
          isNull,
    ...
    test('round-trips through the URI the host prints', () {
      ...
      expect(AgentsPairingInvite.tryParse(invite.toUri().toString()), invite);
    });
