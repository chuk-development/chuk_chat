...
After running, copy the fixture into the app test tree:
    cp tests/fixtures/pairing_vectors.json \\
       ../../app/test/fixtures/agents_pairing_vectors.json
"""
...
from chuk_agents_crypto import DeviceIdentity, transcript
from chuk_agents_crypto.channel_key import derive_channel_key
from chuk_agents_crypto.pairing import (
    CONFIRM_C_LABEL,
    CONFIRM_D_LABEL,
    DEVICE_C_LABEL,
    DEVICE_D_LABEL,
