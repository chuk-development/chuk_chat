"""cowork_config — the one typed configuration for every CoWork process.

Replaces about forty ``COWORK_*`` environment variables read at the point of
...
See :mod:`cowork_config.schema` for every setting and its meaning, and the
