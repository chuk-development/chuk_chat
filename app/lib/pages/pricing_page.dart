// COWORK STUB. Upstream: chuk_chat/lib/pages/pricing_page.dart @ d31526a229fdde27c82adf3661d5d3a149db8340.
// Reason: hosted-only — there is no CoWork subscription: the agent runs on the
