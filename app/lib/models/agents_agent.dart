...
@immutable
class AgentsThreadInfo {
  const AgentsThreadInfo({
    required this.key,
    required this.title,
    this.lastActivity,
  });
  ...
  AgentsThreadInfo copyWith({String? title, DateTime? lastActivity}) =>
      AgentsThreadInfo(
        key: key,
...
class AgentsAgent {
  ...
  final List<AgentsThreadInfo> threads;
