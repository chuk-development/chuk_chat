// AGENTS STUB. Upstream: chuk_chat/lib/tool_handlers/notes_tools.dart.
// Reason: the upstream file is a 700-line client-side notes/identity tool
// handler (Soul / User info / Memory) that runs tools on the device. In Agents
...
///
/// Agents keeps the system prompt on the host (see `user_preferences_service`),
