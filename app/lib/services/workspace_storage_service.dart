// COWORK STUB. Upstream: chuk_chat/lib/services/workspace_storage_service.dart @ d31526a229fdde27c82adf3661d5d3a149db8340.
// Reason: hosted-only — workspaces (projects) are a chuk_chat feature backed by
// Supabase. CoWork's sidebar lists agents (coworkers), not projects, so the
...
class WorkspaceStorageService {
  ...
  static Future<Workspace> createProject(
    ...
    throw UnsupportedError('CoWork has no workspaces.');
  }
