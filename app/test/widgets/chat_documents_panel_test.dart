...
void main() {
  ...
  testWidgets('an open document follows a newer version pushed by the agent', (
    ...
    expect(find.text('v2 · 05.01. 14:03'), findsOneWidget);
  ...
  testWidgets('workspace files are told apart by folder, not by file name', (
    ...
    await tester.pump();
    expect(find.text('skills/automations'), findsOneWidget);
    expect(find.text('skills/browser-to-curl'), findsOneWidget);
    expect(find.text('…/of/folders'), findsOneWidget);
    expect(find.text('README.md'), findsOneWidget);
    // The repeated name moves to the second line, where it costs nothing.
    expect(find.text('SKILL.md · 05.01. 14:03'), findsNWidgets(3));
  });
