...
Du bist eine Flutter-Session im Repo /home/user/git/cowork (Branch agents, geteilter
...
3. docs/PLAN_2026-09-04_AGENTS_CHUK_ALIGN.md — Abschnitt WS-1 (Shell).
...
- rechter Bereich Rooms/Browser, AgentsShellHost oberhalb des Desktop/Mobile-Switch.
- cowork-8y2: AppShellConfig an MessengerShell durchreichen (zwei Leser des Statics:
  agents_thread_view._buildChat und messenger_shell._openSettings; Fixture
  test/support/shell_config.dart), AgentsApp.shellConfig-Static abraeumen.
...
app/lib/widgets/agent_roster_view.dart, agents_shell_state (neu, falls noetig),
...
NICHT deine: agents_thread_view.dart (9e/84/c6 Hooks; nur mit Ansage an cowork-76),
