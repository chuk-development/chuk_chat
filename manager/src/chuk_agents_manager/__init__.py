"""Agents Manager — the host control plane (§5 of the platform plan).
...
from chuk_agents_manager.containers import (
    ContainerSupervisor,
    WorkspaceResolver,
    roster_workspace_resolver,
)
from chuk_agents_manager.names import random_name
from chuk_agents_manager.roster import Agent, RosterStore
from chuk_agents_manager.room_store import RoomStore
from chuk_agents_manager.room_runner import (
    RoomContext,
    RoomOutcome,
    RoomRunner,
)
from chuk_agents_manager.room_driver import (
    OFFLINE_REPLY,
    RoomDriver,
)
from chuk_agents_manager.room_binding import RoomBinding
from chuk_agents_manager.room_transcript import RoomTranscriptStore
...
from chuk_agents_manager.supervisor import (
    AgentSupervisor,
    RuntimeState,
    RuntimeStatus,
    StubSupervisor,
